...
@endsection
    @section('content')
    <div class="container">
    <h1>Create New Leave Balance</h1>
        ...
        <div class="card-body">
            <form action="{{ route('leave_balances.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="used_days" id="used_days" class="form-control" required>
                </div>
                
                <div class="form-group">
                    <label for="remaining_days">Remaining Days</label>
                    <input type="number" name="remaining_days" id="remaining_days" class="form-control" required>
                </div>
